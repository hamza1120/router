...
const App = () => {
  const [movies, setMovies] = useState([
    ...
    },
    {
      title: "Oppenheimer",
      description:
        "During World War II, Lieutenant General Leslie Groves Jr. appointed physicist J. Robert Oppenheimer to work on the top-secret Manhattan Project. Oppenheimer and a team of scientists spent years developing and designing the atomic bomb.",
      posterURL:
        "	https://alternativemovieposters.com/wp-content/uploads/2023/01/Dalton-Frizzell_OPPENHEIMER-1.jpg",
      rating: 4.3,
